...
object Curried {
  ...
  private[sporks] class Curried0[R] extends SporkClassBuilder[Function0[R] => Function0[R]]({ fun1 => curried0(fun1) })
  private[sporks] class Curried1[T1, R] extends SporkClassBuilder[Function1[T1, R] => Function1[T1, R]]({ fun1 => curried1(fun1) })
  private[sporks] class Curried2[T1, T2, R] extends SporkClassBuilder[Function2[T1, T2, R] => Function1[T1, Function1[T2, R]]]({ fun1 => curried2(fun1) })
  private[sporks] class Curried3[T1, T2, T3, R] extends SporkClassBuilder[Function3[T1, T2, T3, R] => Function1[T1, Function1[T2, Function1[T3, R]]]]({ fun1 => curried3(fun1) })
  private[sporks] class Uncurried0[R] extends SporkClassBuilder[Function0[R] => Function0[R]]({ fun1 => uncurried0(fun1) })
  private[sporks] class Uncurried1[T1, R] extends SporkClassBuilder[Function1[T1, R] => Function1[T1, R]]({ fun1 => uncurried1(fun1) })
